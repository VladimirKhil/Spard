...
namespace Spard.Expressions
{
    ...
    public abstract class Expression: IEquatable<Expression>
    {
        ...
        /// <summary>
        /// Replaces current operands with new values.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="Expression" /> class.
        /// </summary>
        internal Expression()
        {
        ...
        /// <summary>
        /// Adds one of the operands to the string representation of the node.
        /// </summary>
        ...
        /// <summary>
        /// Checks if the input object matches the node template.
        /// </summary>
        ...
        /// <returns>Whether the input object matches the node template.</returns>
        ...
        /// <summary>
        /// Gets the output object by applying context to the node template.
        /// </summary>
        /// <param name="context">Applicable context. If you want to get the next output object in the same context, this parameter is null.s</param>
        ...
        /// <summary>
        /// Builds a transiton table: [input element => resuls set].
        /// </summary>
        ...
        internal TransitionTable BuildTransitionTable(TransitionSettings settings, bool isLast) =>
            BuildTransitionTableCore(settings, isLast);

        /// <summary>
        /// Builds a transition table for this expression.
        /// </summary>
        ...
        public virtual bool Equals(Expression other) => GetType() == other.GetType() && Operands().SequenceEqual(other.Operands());
